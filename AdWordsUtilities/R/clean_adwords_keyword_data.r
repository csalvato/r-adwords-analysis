#' Clean Raw AdWords Keyword Data
#'
#' Takes the raw data from an AdWords Keyword Performance Report via an API pull and cleans/formats it
#' to be more easily readable, understandable and consistent with other data sets.
#' @param data_frame A data frame of raw data from an AdWords Keyword Performance Report via an API pull
...
clean_raw_adwords_keyword_data  <- function(data_frame) {
