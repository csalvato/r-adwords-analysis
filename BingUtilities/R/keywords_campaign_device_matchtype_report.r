...
#' @param file String. The filename for the generated report if \code{write_csv} is set to \code{TRUE}. Defaults to bing_keyword_campaign_device_matchtype_report.csv".
...
keywords_campaign_device_matchtype_report <- function(keywords_elog,
                                          ...
                                          write_csv = TRUE,
                                          file="bing_keyword_campaign_device_matchtype_report.csv"){
  require(plyr)
  require(dplyr)
